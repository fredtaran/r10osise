<template>
    <div class="flex flex-col items-center justify-center h-screen">
        <img src="/mgb-logo.png" alt="MGB Logo" class="h-[150px] w-[150px] mb-2">
        <div class="w-[400px] text-center text-2xl font-extrabold mb-3">
            <h1>Mines and Geosciences Bureau - X Online Application for Safety Engineers and Safety Inspector</h1>
        </div>
        <div class="flex flex-col bg-white px-[25px] py-[25px] w-[400px] rounded-lg shadow-lg">
            <h2 class="text-2xl font-bold mb-4">Login your account</h2>
            <form>
                <div class="mb-4">
                ...
                <div class="mt-5">
                    <button type="button"
                        ...
                        <svg class="w-6 h-6text-white mr-1" aria-hidden="true"
